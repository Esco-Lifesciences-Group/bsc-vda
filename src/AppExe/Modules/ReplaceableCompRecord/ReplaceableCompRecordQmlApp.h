...
class ReplaceableCompRecordQmlApp : public QObject
{
    Q_OBJECT
...
public:
    explicit ReplaceableCompRecordQmlApp(QObject *parent = nullptr);
...
public slots:
    ...
    void selectDescendingWithPagination(short pageNumber);
    void deleteAll();
    void deleteWhereOlderThanDays(int days);
    void queryDeleteAtRowId(int descRowId);
    ...
    void filterEmptyStringString(QVariantList value);
...
signals:
    ...
    void filterEmptyStringFinished(QVariantList value);
...
private:
    ...
    void setPrintContent(const QStringList &content, const QString &exportDateTime, const QString &formRpRev,
                         const QString &formRpPath, int startPage, int endPage, int maxPage);
    //    QString _docPdfHeader(const QString exportDateTime, const QString serial);
    QString _docPdf(const QString &exportDateTime, const QString &serial,
                    const QStringList& logReady, const QString &unitModel,
                    int row, int page, int maxPage);
    //    QString _docPdfFooter(int page, int maxPage);
    void checkFiles();
    bool isColumnName(int index);

    QThread *m_pThread      = nullptr;
    QScopedPointer<ReplaceableCompRecordSqlGet> m_pSql;
    ...
    bool filesAreIdentical(const QString &filePath1, const QString &filePath2);
