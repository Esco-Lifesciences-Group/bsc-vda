...
#define DEFAULT_DB_FILENAME                 "systemmonitorlog.db"

#define DB_QUERY_INIT                       "\
CREATE TABLE IF NOT EXISTS systemmonitorlog_V3 \
(date TEXT, time TEXT, cpuUsage TXT, memUsage TXT, cpuTemp TXT, sdCardLife TXT, username TXT, userfullname TXT)"
...
#define DB_QUERY_SELECT                     "SELECT rowid,* FROM systemmonitorlog_V3"
