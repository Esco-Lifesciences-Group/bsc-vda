...
CREATE TABLE IF NOT EXISTS bookingschedule_V2 \
    (date TEXT, time TEXT, bookTitle TEXT, bookBy TEXT, note1 TEXT, note2 TEXT, note3 TEXT, createdAt TEXT, username TEXT)"
...
#define DB_QUERY_UPDATE_USERNAME            "UPDATE bookingschedule_V2 SET username = ? WHERE username = ?"
...
bool BookingScheduleSqlGet::queryUpdateUsername(const QString &value, const QString &username)
{
    bool success = false;
