...
public slots:
    ...
    void updateUsername(const QString &username, const QString &newUsername);
...
signals:
    ...
    void bookingScheduleUsernameUpdated(bool done, const QString &username, const QString &newUsername);
