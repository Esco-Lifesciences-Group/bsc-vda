...
{
#ifdef __arm__
    m_resourcePath = "/home/root/resources/QuickTourAsset.rcc";
#else
...
#ifdef __arm__
        m_resourcePath = "/home/root/resources/GeneralResources.rcc";
#else
        m_resourcePath = QDir::currentPath() + "/GeneralResources.rcc";
#endif
        m_pathCode = pathCode;
        break;
    default:break;
