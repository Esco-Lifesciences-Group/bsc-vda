    ...
    QMetaObject::invokeMethod(m_pSql.data(), [&, pageNumber](){
        ...
        if(done) {
            ...
            for(int i=0; i < logBuffer.length(); i++){
                ...
                item.insert("temp", itemTemp.at(TH_TEMP));
                item.insert("ifa",  itemTemp.at(TH_IFA));
                item.insert("dfa",  itemTemp.at(TH_DFA));
                item.insert("adcIfa", itemTemp.at(TH_ADC_IFA));
                item.insert("pressure", itemTemp.at(TH_PRESSURE));
                item.insert("fanRPM", itemTemp.at(TH_FAN_RPM));
                item.insert("fanDcy", itemTemp.at(TH_FAN_DCY));
                item.insert("username", itemTemp.at(TH_USERNAME));
                item.insert("userfullname", itemTemp.at(TH_USERFULLNAME));
                               ...
                               int pagesCount)
{
    ...
    QMetaObject::invokeMethod(m_pSql.data(), [
        ...
        QString fileName = targetDir + QString("/DataLog_P%1-%2of%3_%4.pdf").arg(pageNumber).arg(pageNumber + pagesCount - 1).arg(totalPages).arg(dateTime);
        ...
        for (int j=0; j<totalPagesNeedToExport; j++){
            ...
            short numberOfParameters = m_seasPressureInstalled ? 7 : 6;
            ...
            int textWidthRectColumn6 = textWidthRectColumn5;
            int textWidthRectColumn7 = textWidthRectColumn5;
            int textWidthRectColumn8 = textWidthRectColumn5;
            int textWidthRectColumn9 = textWidthRectColumn5;
            int textWidthRectColumn10 = textWidthRectColumn5;
            ...
            int colBegin10 = colBegin9 + textWidthRectColumn9;
            ...
            for (int i=pageSection; i<pageSectionLimit; i++) {
                ...
                if(m_seasPressureInstalled){
                    ...
                    rect.setRect(colBegin10, textMarginTop, textWidthRectColumn10, textHeightRect);
                    pPdfPainter->drawRect(rect);
                    textContent = dataHolderMap.value("username").toString();
                    pPdfPainter->drawText(rect, textContent, textOption);
                }else{
                    rect.setRect(colBegin8, textMarginTop, textWidthRectColumn8, textHeightRect);
                    pPdfPainter->drawRect(rect);
...
void DataLogQmlApp::setSeasPressureInstalled(bool value)
{
