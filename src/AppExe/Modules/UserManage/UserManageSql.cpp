...
CREATE TABLE IF NOT EXISTS usermanage_V5 \
(username TEXT, password TEXT, role INT, active INT, fullname TEXT, email TEXT, createdAt TEXT, lastLogin TEXT)"

#define DB_QUERY_ADD                        "INSERT INTO usermanage_V5 VALUES (?, ?, ?, ?, ?, ?, ?, ?)"

#define DB_QUERY_UPDATE_USERNAME            "UPDATE usermanage_V5 SET username = ? WHERE username = ?"
#define DB_QUERY_UPDATE_FULLNAME            "UPDATE usermanage_V5 SET fullname = ? WHERE username = ?"
#define DB_QUERY_UPDATE_EMAIL               "UPDATE usermanage_V5 SET email = ? WHERE username = ?"
#define DB_QUERY_UPDATE_ROLE                "UPDATE usermanage_V5 SET role = ? WHERE username = ?"
#define DB_QUERY_UPDATE_PASSWORD            "UPDATE usermanage_V5 SET password = ? WHERE username = ?"
#define DB_QUERY_UPDATE_LASTLOGIN           "UPDATE usermanage_V5 SET lastLogin = ? WHERE username = ?"

#define DB_QUERY_DELETE                     "DELETE FROM usermanage_V5"
#define DB_QUERY_COUNT_ROWS                 "SELECT COUNT(*) FROM usermanage_V5"

#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_ASC        "SELECT * FROM usermanage_V5 ORDER BY ROWID ASC LIMIT :limit OFFSET :offset;"
#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_DESC       "SELECT * FROM usermanage_V5 ORDER BY ROWID DESC LIMIT :limit OFFSET :offset;"

#define DB_QUERY_SELECT                     "SELECT * FROM usermanage_V5"
