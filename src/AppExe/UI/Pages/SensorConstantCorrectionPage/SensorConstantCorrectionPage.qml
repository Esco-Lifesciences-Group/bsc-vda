                    ...
                    Item{
                        ...
                        TextApp{
                            ...
                            text: qsTr("The default value of the current sensor constant is <b>%1</b>,").arg(MachineData.getInflowSensorConstant()) + " "
                                  ...
                                  + qsTr("The constant of the airflow sensor may vary for different for different ambient temperatures.")
                                  + "<ul><li>"
                                ...
                                viewApp.showBusyPage(qsTr("Setting up..."),
                                                     function onTriggered(cycle){
                                                         if(cycle === MachineAPI.BUSY_CYCLE_1
                                                                 || (MachineData.sensorConstCorrEnable === props.sensorCorrEnable
                                                                     && MachineData.sensorConstCorrHighZone === props.highZoneConst
                                                                     && MachineData.sensorConstCorrLowZone === props.lowZoneConst)){
                                                             props.isThereChanges()
...
///The constant of the esco airflow sensor may be different for different ambient temperatures.
