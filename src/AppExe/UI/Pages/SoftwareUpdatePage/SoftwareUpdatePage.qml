                        ...
                        states: [
                            State {
                                ...
                                PropertyChanges {
                                    ...
                                    text: qsTr("Updated software version is currently available on SVN server") +
                                          "<br>%1<br>%2".arg(props.svnUpdateSwuVersion).arg(qsTr("Tap <b>SVN Update</b> to update!"))
                                }
                            },
                            State {
                                when: !props.svnUpdateAvailable
                                                          ...
                                                          function onAccepted(){
                                                              ...
                                                              if(!isFileExist) {
                                                                  showDialogMessage(qsTr("Warning"),
                                                                                    qsTr("Software update file path does not exist!"),
                                                                                    dialogAlert)
                                                                  return
                                                              }
                            ...
                            ButtonBarApp {
                                ...
                                onClicked: {
                                    ...
                                    viewApp.showDialogAsk(qsTr("Notification"),
                                                          ...
                                                          viewApp.dialogInfo,
                                                          function onAccepted(){
                                                              MachineAPI.insertEventLog(qsTr("User: Open SBC update screens."))
                                                              ////console.debug("SBC Update Load...")
                                                              viewApp.showBusyPage(qsTr("Loading updates..."),
                                                                                   function onTriggered(cycle){
                                                                                       if(cycle >= MachineAPI.BUSY_CYCLE_1){
