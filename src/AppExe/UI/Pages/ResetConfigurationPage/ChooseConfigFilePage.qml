                    ...
                    Item {
                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                ...
                                const message = qsTr("Are you sure you want to import %1 as new settings?").arg(props.fileSelected)
                                viewApp.showDialogAsk(qsTr("Notification"),
                                                      message,
                                                      viewApp.dialogInfo,
                                                      function onAccepted(){
                                                          viewApp.showBusyPage(qsTr("Importing..."), function onCallback(cycle){
