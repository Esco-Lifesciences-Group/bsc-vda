            ...
            Item {
                                                ...
                                                if(UserSessionService.roleLevel >= UserSessionService.roleLevelAdmin
                                                    ...
                                                    showDialogAsk(qsTr(title),
                                                                  ...
                                                                  function onAccepted(){
                                                                      ...
                                                                      MachineAPI.insertEventLog(qsTr("User: Delete event logs starting from %1").arg(props.deleteWhereOlderThanDaysStrf))
                                                                  });
                                                }else
                                                    showDialogMessage(qsTr("Access Denied"),
                                                                      qsTr("You do not have permission to perform this action!"),
                ...
                TextApp{
                    ...
                    MouseArea{
                        ...
                        anchors.fill: parent
                        onClicked: {
                            const intent = IntentApp.create("qrc:/UI/Pages/BackupRestorePage/BackupRestorePage.qml", {"db": "eventlog.db"})
                            startView(intent)
                        }//
                    }//
                }//
        ...
        Loader {
            ...
            sourceComponent: EventLogQmlApp {
                ...
                onLogHasExported: {
                    ...
                    const strEvent = qsTr("User: Generate event logs (export file) %1.").arg(qsTr("(Page: %1-%2)").arg(props.startPageNumberExport).arg(props.endPageNumberExport))
