...
ViewApp {
    ...
    content.sourceComponent: ContentItemApp {
                                ...
                                Rectangle {
                                    ...
                                    TextApp {
                                        ...
                                        Component.onCompleted: {
                                            ...
                                            switch(modelData){
                                            case "Operator": text = qsTr("Operator", "Indicator Grid Menu"); break
        ...
        QtObject {
            ...
            property bool particleCounterInstalled: false

            property bool filterLifeDisplayEn: true
        ...
        executeOnPageVisible: QtObject {
            ...
            Component.onCompleted: {
                ...
                props.particleCounterInstalled = Qt.binding(function(){return MachineData.particleCounterSensorInstalled})
                ...
                if (!props.menuHasCreated) {
                    ...
                    myWorker.sendMessage({"action": "init",
                                             ...
                                             "oneOfTenEnable": setting.oneOfTenEn
                                         })
                }//
            }//
