    ...
    content.sourceComponent: ContentItemApp {
                            ...
                            Flickable {
                                ...
                                Column {
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Daily BSC Preventive Maintenance")
                                        ...
                                        onSwitchChanged: {
                                            ...
                                            MachineAPI.insertEventLog(qsTr("User: %1 Reminder is %2.").arg(label).arg(value ? qsTr("Activated") : qsTr("Deactivated")))
                                        }
                                        onButtonRowPressed: {
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Weekly BSC Preventive Maintenance")
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Monthly BSC Preventive Maintenance")
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Quarterly BSC Preventive Maintenance")
                                        ...
                                        onLoaded: {
                                            //console.debug(MachineData.alarmPreventMaintState, )
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Annual BSC Preventive Maintenance")
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Biennial BSC Preventive Maintenance")
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Quinquennial BSC Preventive Maintenance")
                                    ...
                                    CusComPage.RowItemApp {
                                        ...
                                        label: qsTr("Monthly Canopy Preventive Maintenance")
        ...
        Component.onCompleted: {
            showDialogMessage(qsTr("Preventive Maintenance"),
                              qsTr("Select preventive maintenance to view the checklists, make an acknowledgment, or snooze reminders."),
