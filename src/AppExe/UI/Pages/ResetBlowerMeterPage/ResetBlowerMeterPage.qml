    ...
    content.sourceComponent: ContentItemApp {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                HeaderApp {
                    anchors.fill: parent
                    title: qsTr("Reset Fan Usage Meter")
                }
            }
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: {
                        KeyboardOnScreenCaller.openNumpad(newValueTextField, qsTr("Reset Fan Usage Meter (minutes)"))
                    }//
                }//
                ...
                TextFieldApp {
                    ...
                    onAccepted: {
                        ...
                        MachineAPI.insertEventLog(qsTr("User: Reset fan usage meter to '%1'").arg(utils.strfMinToHumanReadableShort(val)))

                        showBusyPage(qsTr("Setting up..."), function(cycle){
                            if(cycle >= MachineAPI.BUSY_CYCLE_1
                                    || Number(MachineData.fanUsageMeter) == val) {
                                closeDialog()
                            }
                        })
                    }
