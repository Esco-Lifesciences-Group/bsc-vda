                        ...
                        ListView {
                            ...
                            model: [
                                ...
                                {'title':       qsTr("Navigation"),
                                    ...
                                    'description': qsTr("Allows users to move pages using specific gestures in the fastest way. Swipe Up, Down, Right, and Left to know the functions."),
                                    'link': "qrc:/UI/Pages/QuickTourPage/Fragment/GestureNavigation.qml"},

                                ///login section
                                {'title': qsTr("Login"),
                                    'subTitle':    qsTr("Manage Your Cabinet Access"),
                                    'description': qsTr("Set limited access to your cabinet by creating a username and password. Save username and password for easy login next time."),
                                ...
                                {'title': qsTr("Remote Modbus"),
                                    ...
                                    'description': qsTr("Enables user to access the cabinet remotely from other devices such as PC, Mobile phones, etc., to control (write) the primary function with a condition or read the current status of the cabinet."),
                                    'link': "qrc:/UI/Pages/QuickTourPage/Fragment/ModbusSectionQuickTour.qml"},

                                ///evenlog section
                                {'title': qsTr("Log Functions"),
                                    'subTitle':    qsTr("Data Record and Collection Made Easy"),
                                    'description': qsTr("Check, delete, or export the data log, alarm log, or event log. Transfer of data through USB."),
                                ...
                                {'title': qsTr("Booking Scheduler"),
                                    ...
                                    'description': qsTr("Define and schedule cabinet usage for multiple users. Register, edit, cancel, delete, or export the cabinet usage booking schedule through USB."),
                                ...
                                {'title': qsTr("UV Scheduler"),
                                    ...
                                    'description': qsTr("Helps schedule the daily or weekly UV sterilization. Turns off and on the UV lamp prior and after use automatically."),
                                    'link': "qrc:/UI/Pages/QuickTourPage/Fragment/UVSchedulerQuickTour.qml"},
                                ///Fan scheduler
                                {'title': qsTr("Fan Scheduler"),
                                    'subTitle':    qsTr("Your Regular Assistant"),
                                    'description': qsTr("Helps schedule the daily or weekly fan operation. Turns on the fan automatically."),
                                ...
                                {'title': qsTr("Sash Standby"),
                                    ...
                                    'description': qsTr("Move the sash to the standby height and save energy without compromising product protection and your safety!"),
                                ...
                                {'title': qsTr("Airflow Fail"),
                                    ...
                                    'description': qsTr("Audible and visual alarms in any airflow failure."),
                                    'link': "qrc:/UI/Pages/QuickTourPage/Fragment/ErorrAirflow.qml"},

                                ///homepage Error section
                                {'title': qsTr("Sash Unsafe"),
                                    'subTitle':    qsTr("Uncompromising Safety"),
                                    'description': qsTr("Audible and visual alarms in unsafe sash window position."),
