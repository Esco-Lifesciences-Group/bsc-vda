                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                ...
                                if ((props.lowestLimitNew != props.lowestLimitMachine)
                                    ...
                                    MachineAPI.insertEventLog(qsTr("User: Set environmental temp. limit (Low: %1%3, High: %2%3)").arg(props.lowestLimitNew).arg(props.highestLimitNew).arg(props.measurementUnitStr))

                                    showBusyPage(qsTr("Setting up..."), function(cycle){
                                        if(cycle >= MachineAPI.BUSY_CYCLE_1
                                                || (MachineData.envTempLowestLimit == props.lowestLimitNew
                                                    && MachineData.envTempHighestLimit == props.highestLimitNew)) {
