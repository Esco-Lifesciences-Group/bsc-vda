    ...
    content.sourceComponent: ContentItemApp {
        ...
        StackViewApp {
            ...
            Component.onCompleted: {
                var intent = IntentApp.create("qrc:/UI/Pages/FieldCalibratePage/Advanced/_GettingStartedPage.qml", {})
        ...
        QtObject {
            ...
            property string pgStart: "qrc:/UI/Pages/FieldCalibratePage/Advanced/_GettingStartedPage.qml"
            property string pgEnd: "qrc:/UI/Pages/FieldCalibratePage/Advanced/_CalibrationFinishedPage.qml"
            ...
            function confirmBackToClose(){
                ...
                if ((currentPage === props.pgStart) || (currentPage === props.pgEnd)) {
                    if ((props.calledFromWalcomeSetup && (currentPage === props.pgEnd)) || props.skipped ){
                        ...
                        let intent = IntentApp.create(uri, {"welcomesetupdone": 1, "done": props.calibDone})
                        finishView(intent)
                    }
                    else {
                        /// Back to Main Menu
                        let intent = IntentApp.create(uri, {"done": props.calibDone})
                        finishView(intent)
                    }
                }
                else {
        ...
        executeOnPageVisible: QtObject {
            ...
            Component.onCompleted: {
                ...
                if(props.calledFromWalcomeSetup){
                    ...
                    stackView.clear()
                    let intent1 = IntentApp.create("qrc:/UI/Pages/FieldCalibratePage/Advanced/_GettingStartedPage.qml",
                                                   {"welcomesetup": true})
