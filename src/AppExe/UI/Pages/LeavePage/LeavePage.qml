                        ...
                        Column {
                            ...
                            Column {
                                ...
                                TextApp {
                                    ...
                                    rightPadding: 5
                                    text: qsTr("This action is only needed if you want to turn off the unit.")
                                }//
                                ...
                                TextApp {
                                    ...
                                    horizontalAlignment: Text.AlignJustify
                                    rightPadding: 5
                                    text: qsTr("This is to ensure all the tasks are stopped properly and will not cause disk error.")
                                }//
                                ...
                                TextApp {
                                    ...
                                    horizontalAlignment: Text.AlignJustify
                                    rightPadding: 5
                                    text: qsTr("System will automatically turn off all the functions (LED, UV lamp, blower, etc.), then displays black screen.")
                                }//
                                ...
                                TextApp {
                                    ...
                                    horizontalAlignment: Text.AlignJustify
                                    rightPadding: 5
                                    text: qsTr("After the black screen displays for 5 seconds, switch off the power and remove the cord.")
                                }//
                                Rectangle {height: 1; width: parent.width; color: "gray"}
                                TextApp {
                                    anchors.horizontalCenter: parent.horizontalCenter
                                    ...
                                    horizontalAlignment: Text.AlignJustify
                                    rightPadding: 5
                                    text: qsTr("If you intend to turn on the unit again, please plug in the cord and switch on the power.")
                                }//
                                Rectangle {height: 1; width: parent.width; color: "gray"}
                            }//
                            ...
                            Row {
                                ...
                                TextApp {
                                    ...
                                    text: qsTr("Yes, I'm ready to turn off the unit.")
                                }//
                            }//
                        }//
                    }//
