    ...
    content.sourceComponent: ContentItemApp {
                    ...
                    Item {
                        ...
                        Component {
                            ...
                            Item {
                                ...
                                property int secondsInitial: SettingsData.valueToInt("expTimerSecInit", 0)
                                ...
                                Loader {
                                    ...
                                    sourceComponent: TimerTumblerApp {
                                        ...
                                        onSecondsChanged: {
                                            ...
                                            SettingsData.setValue("expTimerSecInit", props.timerCountTotal)
                                        }//
                                    ...
                                    onClicked: {
                                        ...
                                        if (fragmentStackView.currentItem.idname === "progress") {
                                            ...
                                            if (props.timerStatus == ExperimentTimerService.statusPause){
                                                ...
                                                //                                                MachineAPI.insertEventLog(qsTr("Experiment timer is resumed"))
                                            }
                                        }
                                        else {
                                            if (props.timerStatus == ExperimentTimerService.statusStop){
                                            ...
                                            //Show warning when stopwatch timer is active
                                            if((StopwatchTimerService.status === StopwatchTimerService.statusPlay) || (StopwatchTimerService.status === StopwatchTimerService.statusPause)){
                                                let autoClose = false
                                                const message = qsTr("The Stopwatch timer is still active, stopwatch timer will stop if continue.") + "<br>" +
                                            ...
                                            //                                            MachineAPI.insertEventLog(qsTr("Experiment timer started"))
                                        }//
                                    }//
                                }//
                            }//
        ...
        executeOnPageVisible: QtObject {
            ...
            Component.onDestruction: {
                ...
                ExperimentTimerService.experminetTimerOver.disconnect(props.onExperimentTimerOver)
            }
        }//
    }//
}
