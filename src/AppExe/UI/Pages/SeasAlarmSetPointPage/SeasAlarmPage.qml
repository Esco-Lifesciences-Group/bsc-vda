    ...
    content.sourceComponent: ContentItemApp{
            ...
            Item {
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        ButtonBarApp {
                            width: 194
                            visible: (MachineData.seasPressureDiffPaLowLimit !== props.pressureAlarmSet
                                      || MachineData.seasPressureDiffPaOffset !== props.offset)
                            anchors.verticalCenter: parent.verticalCenter
                            ...
                            onClicked: {
                                ...
                                //                                                                 || (MachineData.seasPressureDiffPaLowLimit === props.pressureAlarmSet
                                //                                                                     && MachineData.seasPressureDiffPaOffset === props.offset)){
        ...
        QtObject {
            ...
            function showNotification(){
                const textSet = qsTr("The values have been set!")
                viewApp.showDialogMessage(qsTr("Notification"),
                                          textSet,
                                          viewApp.dialogInfo,
                                          function onCLosed(){
                                              var intent = IntentApp.create("qrc:/UI/Pages/SeasAlarmSetPointPage/_FinishCalibratePage.qml",
                                                                            {})
                                              finishView(intent)
                                          }
                                          )
