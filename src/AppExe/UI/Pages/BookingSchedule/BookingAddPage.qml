    ...
    content.sourceComponent: ContentItemApp{
                ...
                Column {
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            TextApp {
                                height: 30
                                text: qsTr("Date") //+ ":" +  props.bookingTime + " " + props.bookingDate
                                verticalAlignment: Text.AlignVCenter
                            }//
                            TextApp {
                                height: 30
                                text: qsTr("Start Time") //+ ":" +  props.bookingTime + " " + props.bookingDate
                                verticalAlignment: Text.AlignVCenter
                            }//
                            TextApp {
                                height: 30
                                text: qsTr("End Time") //+ ":" +  props.bookingTime + " " + props.bookingDate
                                verticalAlignment: Text.AlignVCenter
                            }//
                        }//
                        Column {
        ...
        QtObject {
            ...
            function generateModelEndTime(startTime){
                let maxHours = 24 - Number(startTime)
