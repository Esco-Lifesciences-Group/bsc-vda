                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                showDialogAsk(qsTr("Certification Reminder"),
                                              qsTr("Are you sure you want to disable the certificate due date reminder?") + "<br><br>" +
                                                  ...
                                                  showBusyPage(qsTr("Setting up..."),
                                                               function onCycle(cycle){
                                                                   if (cycle >= MachineAPI.BUSY_CYCLE_1
                                                                           || MachineData.dateCertificationReminder === noneCertDate){
            ...
            function onReturnFromCalendarPage(returnIntent){
                ...
                if (calendar) {
                    ...
                    showBusyPage(qsTr("Setting up..."),
                                 function onCycle(cycle){
                                     if (cycle >= MachineAPI.BUSY_CYCLE_1
                                             || MachineData.dateCertificationReminder == props.targetDate){
                                         viewApp.closeDialog()
                                     }
                                 })
                }//
