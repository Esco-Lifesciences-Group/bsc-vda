                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                if(props.parameterOnHasChanged){
                                    ...
                                    const message = props.onEnableSet ? qsTr("User: Fan On Scheduler enabled (%1)").arg(setStrf)
                                ...
                                //     const message = props.offEnableSet ? qsTr("User: Fan Off Scheduler enabled (%1)").arg(setStrf)
                                ...
                                showBusyPage(qsTr("Setting up..."), function(cycle){
                                    let valueSet = true
                                    if(props.parameterOnHasChanged){
                                        valueSet &= (MachineData.fanAutoSetTime === props.onTimeSet
                                                     && MachineData.fanAutoSetDayRepeat === props.onRepeatSet
                                                     && MachineData.fanAutoSetWeeklyDay === props.onRepeatDaySet
                                                     && MachineData.fanAutoSetEnabled === props.onEnableSet)

                                    }
                                    // if(props.parameterOffHasChanged){
                                    //     valueSet &= (MachineData.fanAutoSetTimeOff === props.offTimeSet
                                    //                  && MachineData.fanAutoSetDayRepeatOff === props.offRepeatSet
                                    //                  && MachineData.fanAutoSetWeeklyDayOff === props.offRepeatDaySet
                                    //                  && MachineData.fanAutoSetEnabledOff === props.offEnableSet)
                                    // }
