    ...
    content.sourceComponent: ContentItemApp {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                HeaderApp {
                    anchors.fill: parent
                    title: qsTr("Reset UV Life Meter")
                }
            }
            ...
            Item {
                ...
                Column {
                    ...
                    TextApp{
                        text: qsTr("Typical life up to 2,000 hours or 120,000 minutes") //120000  //minutes or 2000 hours
                        color: "#cccccc"
                        font.pixelSize: 16
                    }//
                ...
                TextFieldApp {
                    ...
                    onAccepted: {
                        ...
                        MachineAPI.insertEventLog(qsTr("User: Reset UV life left meter to %1").arg(utils.strfMinToHumanReadableShort(val)))

                        showBusyPage(qsTr("Setting up..."), function(cycle){
                            if(cycle >= MachineAPI.BUSY_CYCLE_1
                                    || MachineData.uvLifeMinutes === val) {
                                closeDialog()
                            }
                        })
                    }
