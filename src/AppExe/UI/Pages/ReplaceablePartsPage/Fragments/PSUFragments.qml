...
Item {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['psu']
    ...
    QtObject{
        ...
        readonly property int startIndex: MachineAPI.RPList_PSU1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['psu']
            }
            else
                props.rpDatabase = rpApp.database[0]['psu']
        }
