...
Item {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['mcbEmi']
    ...
    QtObject{
        ...
        readonly property int startIndex: MachineAPI.RPList_MCBEMI1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['mcbEmi']
            }
            else
                props.rpDatabase = rpApp.database[0]['mcbEmi']
        }
