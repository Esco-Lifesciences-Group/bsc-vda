...
Item {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['uvLed']
    ...
    QtObject{
        id: props
        readonly property int maxRow: 6
        readonly property int startIndex: MachineAPI.RPList_UVLED1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['uvLed']
            }
            else
                props.rpDatabase = rpApp.database[0]['uvLed']
        }
        ...
        function setItemCode(saveToIndex, value, force){
            ...
            //console.debug(String(value), getRpList(Number(saveToIndex)))
