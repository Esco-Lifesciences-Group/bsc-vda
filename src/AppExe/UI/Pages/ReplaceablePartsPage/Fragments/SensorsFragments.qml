...
Item {
                        ...
                        Repeater{
                            ...
                            CusComPage.RowItemApp {
                                ...
                                onCheckedChanged: {
                                    ...
                                    MachineAPI.setReplaceablePartsSettings(indexOnList+(props.maxRow*5), (value ? "1" : "0"))
                                }
                                onIncompleteData: {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['sensors']
    ...
    QtObject{
        ...
        readonly property int startIndex: MachineAPI.RPList_Sensor1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['sensors']
            }
            else
                props.rpDatabase = rpApp.database[0]['sensors']
        }
