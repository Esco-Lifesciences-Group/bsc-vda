...
Item {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['custom']
    ...
    QtObject{
        id: props
        readonly property int maxRow: 8
        readonly property int startIndex: MachineAPI.RPList_Custom1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['custom']
            }
            else
                props.rpDatabase = rpApp.database[0]['custom']
        }
