...
Item {
    ...
    ReplaceablePartsDatabaseApp{
        ...
        Component.onCompleted: {
            //            props.rpDatabase = database[0]['capInd']
    ...
    QtObject{
        ...
        readonly property int startIndex: MachineAPI.RPList_CapInd1Name
        ...
        function updateRpDatabase(){
            if(MachineData.rpExtDatabaseEnable){
                ...
                props.rpDatabase = dataRp['capInd']
            }
            else
                props.rpDatabase = rpApp.database[0]['capInd']
        }
