            ...
            Item {
                                                ...
                                                if(UserSessionService.roleLevel >= UserSessionService.roleLevelService){
                                                    ...
                                                    showDialogAsk(qsTr(title),
                                                                  ...
                                                                  function onAccepted(){
                                                                      ...
                                                                      MachineAPI.insertEventLog(qsTr("User: Delete RP form records starting from %1").arg(props.deleteWhereOlderThanDaysStrf))
                                                                  });
                                                }else
                                                    showDialogMessage(qsTr("Access Denied"),
                                                                      qsTr("You do not have permission to perform this action!"),
                ...
                TextApp{
                    ...
                    MouseArea{
                        ...
                        anchors.fill: parent
                        onClicked: {
                            const intent = IntentApp.create("qrc:/UI/Pages/BackupRestorePage/BackupRestorePage.qml", {"db": "replaceablecomprecord.db"})
                            startView(intent)
                        }//
                    }//
                }//
        ...
        Loader {
            ...
            sourceComponent: ReplaceableCompRecordQmlApp {
                ...
                onLogHasExported: {
                    ...
                    const strEvent = qsTr("User: Generate RP form record (export file) %1.").arg(qsTr("(Page: %1-%2)").arg(props.startPageNumberExport).arg(props.endPageNumberExport))
