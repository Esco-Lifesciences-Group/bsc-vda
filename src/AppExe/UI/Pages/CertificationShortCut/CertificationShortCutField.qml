...
ViewApp {
    id: viewApp
    title: "Field Certification Summary"
    ...
    content.sourceComponent: ContentItemApp {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                HeaderApp {
                    anchors.fill: parent
                    title: qsTr("Field Certification Summary")
                }
            }
            ...
            Item {
                ...
                GridView{
                    ...
                    model: [
                        {mtype         : "menu",
                            mtitle     : qsTr("Basic Certification Summary"),
                        ...
                        {mtype         : "menu",
                            mtitle     : qsTr("Advanced Certification Summary"),
                            micon      : "qrc:/UI/Pictures/menu/cert_report_icon_full.png",
                            mlink      : "qrc:/UI/Pages/CertificationReportPage/CertificationReportFieldAdvPage.qml",
                            fieldOrFull: true,
                        }
                    ]//
                }//
