                ...
                Column {
                    ...
                    Row {
                        ...
                        TextApp {
                            ...
                            text: qsTr("The audible alarm cannot be muted when the sash alarm is currently active.") + "<br><br>" +
                                  qsTr("\"Vivarium mute\" allows you to pre-mute an audio alarm and remain silent when you move the sash to an unsafe height.")
                        }//
                    }//
