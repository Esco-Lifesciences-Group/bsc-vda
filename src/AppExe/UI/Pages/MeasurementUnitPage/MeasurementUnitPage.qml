        ...
        QtObject {
            ...
            function setMeasurementUnit(unit){
                ...
                const message = "<b>" + qsTr("Change measurement unit to ") + unitStr + "?</b>"
                              + "<br><br>"
                              + qsTr("Changing the measurement unit without re-calibration may cause inaccuracy of the airflow value.") + "."
            ...
            function doSetMeasurementUnit(unit){
                ...
                const message = unit ? qsTr("User: Set measurement unit to Imperial")
                                     : qsTr("User: Set measurement unit to Metric")
                ...
                viewApp.showBusyPage(qsTr("Setting up..."),
                                     function onCycle(cycle){
                                         if (cycle >= MachineAPI.BUSY_CYCLE_1
                                                 || MachineData.measurementUnit === unit) {
