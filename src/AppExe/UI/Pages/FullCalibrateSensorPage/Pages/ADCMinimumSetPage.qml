                                ...
                                Column {
                                    ...
                                    Rectangle {
                                        ...
                                        ColumnLayout {
                                            ...
                                            TextApp {
                                                text: qsTr("Set low velocity alarm") + ":"
                                            }//
                                            ...
                                            Item {
                                                ...
                                                TextField {
                                                    ...
                                                    onPressed: {
                                                        KeyboardOnScreenCaller.openNumpad(velocityLowLimitTextField, qsTr("Set low velocity alarm"))
                                                    }//
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                if(props.velocityLowAlarm <= 0.30){
                                    const msg = qsTr("Ensure you have set the low velocity alarm correctly!")
                                    showDialogMessage(qsTr("ADC Minimum"), msg, dialogAlert, function(){}, false)
                                }
                                else{
