...
//                                }//
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        ...
                                        if (index == 0){
                                            ...
                                            if((MachineData.getAirflowFactoryCalibrationState(0) === true) && (MachineData.getAirflowFactoryCalibrationState(1) === true) &&
                                               (MachineData.getAirflowFactoryCalibrationState(2) === true) && (MachineData.getAirflowFactoryCalibrationState(3) === true)){
        ...
        QtObject {
            ...
            function openPage(pid, uri, title){
                ...
                ///THIS SECONDARY METHOD
                else if (pid === 'meaifanomsec'){
                    //let calibrateReq = props.calibrateReqValues['measure']['ifa']['nominal']
                    let calibrateReq = props.calibrateReqValuesSec['measure']['ifa']['nominal']
                    ...
                    let calibrateReq = props.calibrateReqValuesSec['measure']['ifa']['minimum']
                    ...
                    let calibrateReq = props.calibrateReqValuesSec['measure']['ifa']['stb']
...
//                    }
            ...
            function initCalibrateSpecs(profile){
                ...
                for (const label of ['nominal', 'minimum', 'stb']){
                    ...
                    //Secondary
                    //props.calibrateReqValuesSec['measure']['ifa'][label]['volume']             = profile['airflow']['ifa']['sec'][label][meaUnitStr]['volume']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['velocity']           = profile['airflow']['ifa']['sec'][label][meaUnitStr]['velocity']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['velocityTol']        = profile['airflow']['ifa']['sec'][label][meaUnitStr]['velocityTol']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['velocityTolLow']     = profile['airflow']['ifa']['sec'][label][meaUnitStr]['velocityTolLow']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['velocityTolHigh']    = profile['airflow']['ifa']['sec'][label][meaUnitStr]['velocityTolHigh']
                    //props.calibrateReqValuesSec['measure']['ifa'][label]['openingArea']        = profile['airflow']['ifa']['sec'][label][meaUnitStr]['openingArea']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['gridCount']          = profile['airflow']['ifa']['sec'][label]['gridCount']
                    props.calibrateReqValuesSec['measure']['ifa'][label]['correctionFactor']   = profile['airflow']['ifa']['sec'][label]['correctionFactor']
                }//
...
//                },
            ...
            property var calibrateReqValuesSec: {
                "measure": {
                    "ifa": {
                        "nominal": {
                            "volume": 0,
            ...
            viewApp.showBusyPage(qsTr("Please wait!"),
                                 function onCallback(cycle){
                                     ...
                                     if(cycle === MachineAPI.BUSY_CYCLE_1 && !executed) {
                                         ...
                                         props.menuModelCabinet[0]['submenu'][0]['submenu'][0]['badge'] = MachineData.getAirflowFactoryCalibrationState(0) === true ? 1 : 0 // IF Nominal
                                         props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge'] = MachineData.getAirflowFactoryCalibrationState(1) === true ? 1 : 0 // IF Fail
                                         props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge'] = MachineData.getAirflowFactoryCalibrationState(2) === true ? 1 : 0 // IF Standby

                                         //Check other menu - dim
                                         if(props.menuModelCabinet[0]['submenu'][0]['submenu'][0]['badge'] === 1 &&
                                            props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge'] === 1 &&
                                            props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge'] === 1){
                                             props.menuModelCabinet[0]['submenu'][0]['badge'] = 1;
                                         }//
                                         if(props.menuModelCabinet[0]['submenu'][0]['badge'] === 1 ||
                                            props.menuModelCabinet[0]['submenu'][1]['badge'] === 1){
                                             props.menuModelCabinet[0]['badge'] = 1
                                         }//

                                         //props.menuModelCabinet[0]['badge'] = MachineData.getAirflowFactoryCalibrationState(0) === true ? 1 : 0 // IF Nominal
                                         //props.menuModelCabinet[1]['badge'] = MachineData.getAirflowFactoryCalibrationState(1) === true ? 1 : 0 // IF Fail
                                         //props.menuModelCabinet[2]['badge'] = MachineData.getAirflowFactoryCalibrationState(2) === true ? 1 : 0 // IF Standby
                                         props.menuModelCabinet[1]['badge'] = MachineData.getAirflowFactoryCalibrationState(3) === true ? 1 : 0 // DF Nominal
                                         ...
                                         props.menuModelMicroADC[2]['badge'] = MachineData.getAdcFactoryCalibrationState(2) === true ? 1 : 0 //Adc Nominal
                ...
                function onFinishViewReturned(intent){
                    ...
                    if (extradata['pid'] === 'meaifanom'){
                        ...
                        if(extradata['calibrateRes']['fanDucy'] !== props.fanDutyCycleNominal){
                            ...
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge'] = 0 // If Min
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge'] = 0 // If Nom
                            props.menuModelCabinet[1]['badge'] = 0 //DF Nom
                            menuStackView.currentItem.model = props.menuModelCabinet[0]['submenu'][0]['submenu']
                        ...
                        let done  = props.menuModelCabinet[0]['submenu'][0]['submenu'][0]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][0]['badge'] = 1
                            /// update to current menu
                            menuStackView.currentItem.model = props.menuModelCabinet[0]['submenu'][0]['submenu']
                            //Save to backend
                        ...
                        let done = props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge'] = 1
                            //Check other menu
                        ...
                        let done  = props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge'] = 1
                            //Check other menu
                    ...
                    else if (extradata['pid'] === 'meaifanomsec'){
                        //                            //console.debug(JSON.stringify(extradata['result']['grid']))
                        ...
                        if(extradata['calibrateRes']['fanDucy'] !== props.fanDutyCycleNominal){
                            props.menuModelCabinet[0]['submenu'][1]['submenu'][1]['badge'] = 0 // If Min
                            props.menuModelCabinet[0]['submenu'][1]['submenu'][2]['badge'] = 0 // If Nom
                            props.menuModelCabinet[1]['badge'] = 0 //DF Nom
                            menuStackView.currentItem.model = props.menuModelCabinet
                            MachineAPI.setAirflowFactorySecondaryCalibrationState(1, false)
                            MachineAPI.setAirflowFactorySecondaryCalibrationState(2, false)
                        ...
                        let done  = props.menuModelCabinet[0]['submenu'][1]['submenu'][0]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][1]['submenu'][0]['badge'] = 1
                            /// update to current menu
                            menuStackView.currentItem.model = props.menuModelCabinet[0]['submenu'][1]['submenu']
                            //Save to backend
                    ...
                    else if (extradata['pid'] === 'meaifaminsec'){
                        //                            //console.debug('bagde')
                        ...
                        let done = props.menuModelCabinet[0]['submenu'][1]['submenu'][1]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][1]['submenu'][1]['badge'] = 1
                            //Check other menu
                            if(props.menuModelCabinet[0]['submenu'][1]['submenu'][0]['badge'] === 1 &&
                               props.menuModelCabinet[0]['submenu'][1]['submenu'][1]['badge'] === 1 &&
                               props.menuModelCabinet[0]['submenu'][1]['submenu'][2]['badge'] === 1){
                                props.menuModelCabinet[0]['submenu'][1]['badge'] = 1;
                            }//
                            if(props.menuModelCabinet[0]['submenu'][0]['badge'] === 1 ||
                               props.menuModelCabinet[0]['submenu'][1]['badge'] === 1){
                    ...
                    else if (extradata['pid'] === 'meaifastbsec'){
                        //                            //console.debug('bagde')
                        ...
                        let done  = props.menuModelCabinet[0]['submenu'][1]['submenu'][2]['badge']
                        if (!done){
                            /// set bagde value to main model
                            props.menuModelCabinet[0]['submenu'][1]['submenu'][2]['badge'] = 1
                            //Check other menu
                        ...
                        if(extradata['calibrateRes']['fanDucy'] !== props.fanDutyCycleNominal){
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][0]['badge'] = 0
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][1]['badge'] = 0
                            props.menuModelCabinet[0]['submenu'][0]['submenu'][2]['badge'] = 0
                            props.menuModelCabinet[0]['submenu'][0]['badge'] = 0;
                            props.menuModelCabinet[0]['submenu'][0]['badge'] = 0;
                            menuStackView.currentItem.model = props.menuModelCabinet
                            MachineAPI.setAirflowFactoryCalibrationState(0, false)
                            MachineAPI.setAirflowFactoryCalibrationState(1, false)
