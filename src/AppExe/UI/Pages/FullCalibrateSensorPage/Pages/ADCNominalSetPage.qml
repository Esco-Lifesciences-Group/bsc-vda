                                ...
                                Column {
                                    ...
                                    Rectangle {
                                        ...
                                        ColumnLayout {
                                            ...
                                            TextApp {
                                                text: "Duty Cycle: " + props.fanDutyCycleActual + " %"
                                            }//
                ...
                Component {
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            TextApp {
                                text: qsTr("Please wait for %1").arg(utilsApp.strfSecsToHumanReadableShort(props.timerCountDown)) + ":"
                            }//
                                ...
                                Timer {
                                    ...
                                    onTriggered: {
                                        if(count > 0) {
                                            ...
                                            let velocityValid = props.velocity > props.velocityMin ? true : false
                                            let adcNominalValid = (props.sensorAdcMinimum - props.sensorAdcZero) >= 80 ? true : false
                                            let adcMinimumValid = (adc - props.sensorAdcMinimum) >= 80 ? true : false
                                            ...
                                            if (adcNominalValid && adcMinimumValid && velocityValid && fanDutyCycle) {
...
//                                        }
                                ...
                                if (fragmentStackView.currentItem.idname === "result"){
                                    if(props.calibrateDone) {
                                        let intent = IntentApp.create(uri,
                                                                      {
                                                                          "pid": props.pid,
                                                                          "sensorAdcNominal": props.adcResult,
        ...
        QtObject {
            ...
            property int timerCountDown: 180
        }
