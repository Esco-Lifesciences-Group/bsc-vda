                        ...
                        Component.onCompleted: {
                            if (!props.calibrateDone){
                                ...
                                /// Save the Calibration data Immediately once done
                                {
                                    ...
                                    /// Nominal
                                    MachineAPI.setInflowAdcPointFactory(MachineAPI.POINT_NOMINAL, props.adcNominalResult)
                                    ...
                                    const message = qsTr("User: Full sensor calibration")
                                                  ...
                                                  + "VEL-IF1: " + (velocityMin / 100).toFixed(props.velocityDecimalPoint) + ", "
                                                  + "VEL-IF2: " + (velocityNom / 100).toFixed(props.velocityDecimalPoint) + ", "
                                                  + "FAN-IF1: %1% | %2RPM".arg(props.fanDutyCycleMinimum).arg(props.fanRpmMinimum) + ", "
                                                  + "FAN_IF2: %1% | %2RPM".arg(props.fanDutyCycleNominal).arg(props.fanRpmNominal) + ", "
