                ...
                Component {
                    ...
                    Item{
                        ...
                        Row {
                            ...
                            TextApp{
                                text:  qsTr("The UV timer will limit the duration of the UV lamp when it is turned on.") + "."
                                       + "<br>"
                                       + qsTr("The UV lamp will turn off automatically once the timer is up.") + "."
                                color: "#cccccc"
                                font.pixelSize: 16
                                ...
                                Frame {
                                    ...
                                    Column{
                                        ...
                                        Row {
                                            ...
                                            Tumbler {
                                                id: hoursTumbler
                                                model: ((minutesTumbler.currentIndex == 0) ? 25 : 24)
                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                ...
                                if(props.requestTime !== props.uvTime){
                                    ...
                                    const uvTimeSec = props.requestTime*60
                                    const eventStr = utilsApp.strfSecsToHumanReadableShort(uvTimeSec ? uvTimeSec : qsTr("Infinite"))
                                    MachineAPI.insertEventLog(qsTr("User: Set UV timer to %1").arg(eventStr))
                                    ...
                                    viewApp.showBusyPage(qsTr("Setting up..."),
                                                         function onCycle(cycle){
                                                             if (cycle >= MachineAPI.BUSY_CYCLE_1
                                                                     || MachineData.uvTime == props.requestTime) {
                                                                 fragmentStackView.pop()
