...
ViewApp {
    ...
    content.sourceComponent: ContentItemApp {
                            ...
                            ColumnLayout {
                                ...
                                Item {
                                    ...
                                    Column {
                                        ...
                                        Column{
                                            visible: props.connected || NetworkService.connecting
                                            spacing: 10
                                                ...
                                                TextApp {
                                                    ...
                                                    MouseArea {
                                                        ...
                                                        onClicked: {
                                                            ...
                                                            MachineAPI.insertEventLog(qsTr("User: Forget Wi-Fi connection (%1)").arg(NetworkService.connName))
                                                        }
                                                    }//
                                                }//
                                            }//
                                                ...
                                                onClicked: {
                                                    ...
                                                    if (modelData.exist === "NEW"){
                                                        if(modelData.security.length){
                                                            ...
                                                            MachineAPI.insertEventLog(qsTr("User: Connect to new access point (%1)").arg(props.wifiSelectedAccessPoint))
                                                        }
                                                    }
                                                    else{
                                                        NetworkService.connectTo(props.wifiSelectedAccessPoint)
                                                        MachineAPI.insertEventLog(qsTr("User: Connect to access point (%1)").arg(props.wifiSelectedAccessPoint))
                                                    }
                                                }//
                                            }//
                                                ...
                                                TextApp {
                                                    ...
                                                    MouseArea {
                                                        ...
                                                        onClicked: {
                                                            ...
                                                            MachineAPI.insertEventLog(qsTr("User: Forget Wi-Fi connection (%1)").arg(modelData.name))
                                                        }//
                                                    }//
                                                }//
                                            }//
                                                ...
                                                TextFieldApp {
                                                    ...
                                                    onAccepted: {
                                                        ...
                                                        if(text.match(regex)){
                                                            ...
                                                            showDialogMessage(qsTr("Network"),
                        ...
                        Row{
                            ...
                            ButtonBarApp {
                                ...
                                onClicked: {
                                    ...
                                    MachineAPI.insertEventLog(qsTr("User: Set static wired connection (%1 | %2 | %3)").arg(props.ethEn ? qsTr("Enable") : qsTr("Disable")).arg(props.ethConName).arg(props.ipv4Address))

                                    //                                        }
                                    //                                        if(cycle === 2) {
                                    showDialogAsk(qsTr("Network"),
                                                  qsTr("You may need to restart the system to apply these changes."),
                                                  dialogAlert,
                                                  function onAccepted(){
                                                      showBusyPage(qsTr("Restart..."), function onCallback(cycle1){
                                                          if(cycle1 >= MachineAPI.BUSY_CYCLE_1){
        ...
        QtObject {
            ...
            onConnectedChanged: {
                MachineAPI.setNetworkConnectedStatus(connected)
            }
        ...
        executeOnPageVisible: QtObject {
            ...
            Component.onCompleted: {
                ...
                props.connected = Qt.binding(function(){return NetworkService.connected})
