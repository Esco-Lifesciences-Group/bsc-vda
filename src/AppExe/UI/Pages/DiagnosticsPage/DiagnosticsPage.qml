                    ...
                    Flickable {
                        ...
                        Column {
                            ...
                            CusComPage.RowItemApp {
                                ...
                                onLoaded: {
                                    value = Qt.binding(function(){
                                        if(MachineData.fanPrimaryState !== MachineAPI.FAN_STATE_STANDBY){
                                ...
                                onLoaded: {
                                    value = Qt.binding(function(){
                                        ...
                                        case MachineAPI.SASH_STATE_FULLY_CLOSE_SSV:
                                            return qsTr("Fully closed")
                                        case MachineAPI.SASH_STATE_FULLY_OPEN_SSV:
                                            return qsTr("Fully opened")
                                ...
                                onLoaded: {
                                    value = Qt.binding(function(){
                                        ...
                                        if(MachineData.filterLifeCalculationMode == MachineAPI.FilterLifeCalc_BlowerRpm)
                                            strLife = " (%1 RPM)".arg(MachineData.filterLifeRpm)
                                        else
                                            strLife = " (%1)".arg(utilsApp.strfSecsToHumanReadableShort(MachineData.filterLifeMinutes * 60))

                                        return MachineData.filterLifePercent + "%" + strLife
                                    })
                                }
                            }//
                            ...
                            CusComPage.RowItemApp {
                                ...
                                viewContentY: view.contentY
                                viewSpan: view.span
                                enabled: MachineData.sensorConstCorrEnable

                                label: qsTr("ADC IFN (Corrected)")

                                onLoaded: {
                                    value = MachineData.getAdcInflowPointCorrection(2)
                                }//
                            }//
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("ADC IFF (Corrected)")

                                onLoaded: {
                                    value = MachineData.getAdcInflowPointCorrection(1)
                                }//
                            }//
                            CusComPage.RowItemApp {
                                id: if2ADC
                            ...
                            CusComPage.RowItemApp {
                                ...
                                viewContentY: view.contentY
                                viewSpan: view.span
                                enabled: MachineData.getInflowAdcPointFactory(0) > 0
                            ...
                            CusComPage.RowItemApp {
                                ...
                                onLoaded: {
                                    const pressure = MachineData.seasPressureDiffStr
                            ...
                            CusComPage.RowItemApp {
                                ...
                                onLoaded: {
                                    const pressure = MachineData.seasPressureDiffPaNominal
                            ...
                            CusComPage.RowItemApp {
                                ...
                                onLoaded: {
                                    const pressure = MachineData.seasPressureDiffPaLowLimit
                            ...
                            CusComPage.RowItemApp {
                                ...
                                value: connected ? qsTr("NA") : qsTr("NA")
                            ...
                            CusComPage.RowItemApp {
                                ...
                                value: connected ? qsTr("Fail") : qsTr("OK")
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("Module - Hybrid Analog/Output CH1")
                                value: connected ? qsTr("OK") : qsTr("Fail")
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("Module - Hybrid Analog/Output CH2")
                                value: connected ? qsTr("NA") : qsTr("NA")
                            ...
                            CusComPage.RowItemApp {
                                id: moduleParticleCount
                                width: view.width
                                height: 50
                                viewContentY: view.contentY
                                viewSpan: view.span

                                label: qsTr("Module - Particle Counter Sensor")
                                value: connected ? qsTr("OK") : qsTr("Fail")

                                property bool connected: false

                                onLoaded: {
                                    connected = Qt.binding(function() { return MachineData.boardStatusParticleCounter })
                                }
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("Particle counter (PM2.5 | PM1.0 | PM10) (μg/m3)")

                                //value: "PM2.5: " + particleCounterPM2_5 +
                                //       " | PM1.0: " + particleCounterPM1_0 +
                                //       " | PM10: " + particleCounterPM10

                                value: particleCounterPM2_5 +
                                       " | " + particleCounterPM1_0 +
                                       " | " + particleCounterPM10
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("Particle counter state")
                            ...
                            CusComPage.RowItemApp {
                                ...
                                label: qsTr("Cabinet Up Time")

                                onLoaded: {
                                    value = Qt.binding(function(){ return utilsApp.strfSecsToHumanReadableShort(MachineData.cabinetUpTime)})
                                }//
                            }//
                        }//
                    }//
