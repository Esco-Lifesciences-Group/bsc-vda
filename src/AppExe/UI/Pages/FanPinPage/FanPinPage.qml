...
ViewApp {
    ...
    content.sourceComponent: ContentItemApp {
                            ...
                            onTextChanged: {
                                if (text.length == maximumLength) {
                                    ...
                                    if (props.fanPIN === pinEncode){
                                        ...
                                        if (attempt === props.maximumAttempt) {
                                            MachineAPI.insertEventLog(qsTr("User: Has entered an incorrect PIN for several times."))
        ...
        QtObject {
            ...
            readonly property int maximumAttempt: 0
