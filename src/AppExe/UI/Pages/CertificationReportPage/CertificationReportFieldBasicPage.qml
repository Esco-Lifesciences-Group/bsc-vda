...
ViewApp {
    id: viewApp
    title: "Field Certification Summary - Basic"
    ...
    content.sourceComponent: ContentItemApp{
        ...
        ColumnLayout {
            ...
            Item {
                ...
                HeaderApp {
                    id: headerApp
                    anchors.fill: parent
                    title: qsTr("Field Certification Summary - Basic")
                }
            }
        ...
        Component.onCompleted: {
            ...
            const modelField = [
                                 {"title": qsTr("Model"),               "link": "Fragments/ProfileFragment.qml"},
                                 {"title": qsTr("Airflow"),             "link": "Fragments/AirflowFieldFragment.qml"},
                                 {"title": qsTr("ADC"),                 "link": "Fragments/ADCFieldFragment.qml"},
                                 {"title": qsTr("Tester"),              "link": "Fragments/TesterFieldFragment.qml"},
                                 {"title": qsTr("Export"),              "link": "Fragments/ExportFieldFragmentB.qml"},
                             ]
