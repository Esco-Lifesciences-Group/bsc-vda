...
ViewApp {
    id: viewApp
    title: "Field Certification Summary - Advanced"
    ...
    content.sourceComponent: ContentItemApp{
        ...
        ColumnLayout {
            ...
            Item {
                ...
                HeaderApp {
                    id: headerApp
                    anchors.fill: parent
                    title: qsTr("Field Certification Summary - Advanced")
                }
            }
                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                ...
                                if(index>=0){
                                    ...
                                    const message = qsTr("Are you sure you want to close?") + "<br><br>" +
        ...
        Component.onCompleted: {
            ...
            const modelField = [
                                 {"title": qsTr("Model"),              "link": "Fragments/ProfileFragment.qml"},
                                 {"title": qsTr("Inflow (DIM)"),       "link": "Fragments/InflowGridDimFieldFragment.qml"},
                                 {"title": qsTr("Inflow (Secondary)"), "link": "Fragments/InflowGridSecFieldFragment.qml"},
                                 {"title": qsTr("Downflow"),           "link": "Fragments/DownflowGridFieldFragment.qml"},
                                 {"title": qsTr("ADC"),                "link": "Fragments/ADCFieldFragment.qml"},
                                 {"title": qsTr("Tester"),             "link": "Fragments/TesterFieldFragment.qml"},
                                 {"title": qsTr("Export"),             "link": "Fragments/ExportFieldFragmentA.qml"},
                             ]

            pageIndexListView.model = /*props.fieldOrFull ? modelFull : */modelField

            fragmentLoader.setSource("Fragments/ProfileFragment.qml",
                                     {
                                         "fieldOrFull": props.fieldOrFull,
                                         "fieldAdvanced": true
                                     })
