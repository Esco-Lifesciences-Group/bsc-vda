...
Item {
                            ...
                            Item {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: {
                                        ...
                                        let targetFileName = fileName + "_" + serialNumber + "_Field_Basic" + ".txt"
        ...
        sourceComponent: TestReportPdfGenerator {
            ...
            onInitializedChanged: {
                ...
                if(initialized){
                    ...
                    if(serialNumber.length === 0) serialNumber = "00000"
                    let targetFileName
                    targetFileName = serialNumber + "_" + settingsCert.cabinetModel + "_Field_Basic_" + props.pdfOutputType + "_%1.pdf".arg(dateTimeStr)
    ...
    function generatePayload(trt, pftr, pfcr){
        let dataTestReport = {
            ...
            "test_number":         settingsCert.testReportNoFieldB
        }//
