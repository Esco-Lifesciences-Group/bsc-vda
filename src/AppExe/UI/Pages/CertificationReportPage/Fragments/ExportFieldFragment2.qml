...
Item {
    ...
    function generatePayload(trt, pftr, pfcr){
        let dataTestReport = {
            ...
            "ifa_nom_vel" :         MachineData.getInflowVelocityPointField(MachineAPI.POINT_NOMINAL),
            "ifa_min_vel" :         MachineData.getInflowVelocityPointField(MachineAPI.POINT_MINIMUM),
            "dfa_nom_vel" :         MachineData.getDownflowVelocityPointField(MachineAPI.POINT_NOMINAL),

            "ifa_fail_vel":         MachineData.getInflowLowLimitVelocity(),

            "ducy_nom":             MachineData.getFanPrimaryNominalDutyCycleField(),
            "ducy_min":             MachineData.getFanPrimaryMinimumDutyCycleField(),
            "ducy_stb":             MachineData.getFanPrimaryStandbyDutyCycleField(),

            "rpm_nom":              MachineData.getFanPrimaryNominalRpm(),
            "rpm_min":              MachineData.getFanPrimaryMinimumRpm(),
            "rpm_stb":              MachineData.getFanPrimaryMinimumRpm(),

            "adc_iff":              MachineData.getInflowAdcPointField(MachineAPI.POINT_MINIMUM),
            "adc_ifn":              MachineData.getInflowAdcPointField(MachineAPI.POINT_NOMINAL),
            "adc_ifa":              settingsCert.adcActual,

            "adc_range":            MachineData.getInflowAdcPointField(MachineAPI.POINT_NOMINAL) - MachineData.getInflowAdcPointField(MachineAPI.POINT_MINIMUM),
