                    ...
                    ListView {
                        ...
                        header: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Rectangle{
                                    visible: MachineData.seasInstalled
                                    Layout.minimumHeight: 0.8*parent.height
                                    Layout.minimumWidth: 1
                                    color: "#e3dac9"
                                }
                            ...
                            MouseArea{
                                ...
                                onClicked: {
                                    const details = qsTr("Date Time:") + " %1 %2".arg(modelData.date).arg(modelData.time) + "<br>" +
                                                  ...
                                                  qsTr("Fan Speed:") + " %1%, %2RPM".arg(modelData.fanDcy).arg(modelData.fanRPM) + "<br>" +
                                                  qsTr("User:") + " %1".arg(modelData.username)
                                    const interval = 5000
