...
ViewApp {
    ...
    content.sourceComponent: ContentItemApp {
        ...
        QtObject {
            ...
            property string messageText: qsTr("Shutting down...")
        ...
        executeOnPageVisible: QtObject {
            ...
            Component.onCompleted: {
                ...
                const extraData = IntentApp.getExtraData(intent)
                let message = extraData["message"]
                // console.debug(message, extraData["message"] !== undefined)
                if(extraData["message"] !== undefined && extraData["message"] !== ""){
