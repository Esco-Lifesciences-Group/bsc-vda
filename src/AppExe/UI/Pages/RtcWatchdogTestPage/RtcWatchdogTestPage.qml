                        ...
                        ButtonBarApp {
                            ...
                            onClicked: {
                                ...
                                showDialogAsk(qsTr("Attention!"),
                                              qsTr("Watchdog will keep counting down until zero (0)! If the watchdog system detects no issue, HMI will restart."),
                                              dialogAlert,
                                              function onClickedYes(){
                                                  MachineAPI.insertEventLog(qsTr("User: RTC watchdog test is started."))
