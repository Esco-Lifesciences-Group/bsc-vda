...
Item {
    ...
    property bool   inflowAlarm: false
    property bool   downflowAlarm: false
    ...
    Item {
        ...
        Image {
            ...
            source: control.downflowAlarm ? "BiosafetyCabinet3D/pictures/BSC3D_arrow_df_red.png"
                                        : "BiosafetyCabinet3D/pictures/BSC3D_arrow_df_green.png"
        ...
        Image {
            ...
            property bool airflowAnimationElbow: true
            source: control.inflowAlarm ? (!airflowAnimationElbow ? "BiosafetyCabinet3D/pictures/BSC3D_arrow_if_red.png" : "BiosafetyCabinet3D/pictures/BSC3D_arrow_if_red_elbow.png")
                                        : (!airflowAnimationElbow ? "BiosafetyCabinet3D/pictures/BSC3D_arrow_if_green.png" : "BiosafetyCabinet3D/pictures/BSC3D_arrow_if_green_elbow.png")
            height: parent.height
            width: parent.width
            fillMode: Image.PreserveAspectFit
        }//
    ...
    SequentialAnimation{
        ...
        PropertyAction{
            target: inflowImage
            property: "airflowAnimationElbow"//"source"
            value: false//"BiosafetyCabinet3D/pictures/BSC3D_arrow_if_green.png"
        }//
        ...
        PropertyAction{
            target: inflowImage
            property: "airflowAnimationElbow"//"source"
            value: true//"BiosafetyCabinet3D/pictures/BSC3D_arrow_if_green_elbow.png"
        }//
