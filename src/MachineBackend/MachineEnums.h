...
enum InflowGridPoint{
    INFLOW_GRID_STANDBY,
    INFLOW_GRID_MINIMUM,
    INFLOW_GRID_NOMINAL,
    INFLOW_GRID_TOTAL
};
Q_ENUMS(InflowGridPoint)

enum DownflowGridPoint{
    DOWNFLOW_GRID_MINIMUM,
    DOWNFLOW_GRID_NOMINAL,
    DOWNFLOW_GRID_MAXIMUM,
    DOWNFLOW_GRID_TOTAL
};
Q_ENUMS(DownflowGridPoint)
...
enum ReplaceableTableHeaderEnums {
    ...
    RPList_Filter4Size,
    RPList_Filter5Size,
    RPList_Filter1Airflow,
    RPList_Filter2Airflow,
    RPList_Filter3Airflow,
    RPList_Filter4Airflow,
    RPList_Filter5Airflow,
    RPList_Filter1PD,
    RPList_Filter2PD,
    RPList_Filter3PD,
    RPList_Filter4PD,
    ...
    RPList_Total,
    RPList_CheckedBy = RPList_UserManualCode
};
...
enum ScreenState{
    ...
    ScreenState_Login,
    ScreenState_Calibration,
    ScreenState_FanSpeed,
...
enum CalibrationStateField{
    ...
    CalFieldState_InflowDimMinimum,
    CalFieldState_InflowDimStandby,
    CalFieldState_InflowSecNominal,
    CalFieldState_InflowSecMinimum,
    CalFieldState_InflowSecStandby,
    CalFieldState_DownflowNominal,
    CalFieldState_SensorConstant,
    CalFieldState_AdcCalib,
    CalFieldState_Total
};
...
enum FanSpeedController{
    FanSpeedController_RBM,
    FanSpeedController_Analog,
    FanSpeedController_PWM,
    FanSpeedController_EON,
    FanSpeedController_Total
};
Q_ENUMS(FanSpeedController)

/// category: "certification"
/// check MachineBackend::_initCertificationParameters()
enum CertifParamString{
    CertifParamStr_serverIPv4,
    CertifParamStr_cabinetModel,
    CertifParamStr_woNumber,
    CertifParamStr_calibProc,
    CertifParamStr_calibProcField,
    CertifParamStr_testReportNo,
    CertifParamStr_certifNo,
    CertifParamStr_serialNumber,
    CertifParamStr_powerRating,
    CertifParamStr_pressRoom,
    CertifParamStr_paoCons,
    CertifParamStr_dfParPenet,
    CertifParamStr_ifParPenet,
    CertifParamStr_damperOpen,
    CertifParamStr_damperOpenImp,
    CertifParamStr_mvInitialDfa,
    CertifParamStr_mvInitialIfa,
    CertifParamStr_mvInitialDfaImp,
    CertifParamStr_mvInitialIfaImp,
    CertifParamStr_mvInitialPower,
    CertifParamStr_mvBlockDfa,
    CertifParamStr_mvBlockIfa,
    CertifParamStr_mvBlockDfaImp,
    CertifParamStr_mvBlockIfaImp,
    CertifParamStr_mvBlockPower,
    CertifParamStr_mvFinalDfa,
    CertifParamStr_mvFinalIfa,
    CertifParamStr_mvFinalDfaImp,
    CertifParamStr_mvFinalIfaImp,
    CertifParamStr_sensorVdc,
    CertifParamStr_testerName,
    CertifParamStr_testerSignature,
    CertifParamStr_checkerName,
    CertifParamStr_checkerSignature,
    CertifParamStr_customer,
    CertifParamStr_country,
    CertifParamStr_dateTest,
    CertifParamStr_swVersion,
    /// Field
    CertifParamStr_testerNameField,
    CertifParamStr_testerSignatureField,
    CertifParamStr_checkerNameField,
    CertifParamStr_checkerSignatureField,
    CertifParamStr_testReportNoFieldA,
    CertifParamStr_testReportNoFieldB,

    CertifParamStr_Total
};
Q_ENUMS(CertifParamString)

enum CertifParamInteger{
    CertifParamInt_cabinetSize,
    CertifParamInt_tempRoom,
    CertifParamInt_tempRoomImp,
    CertifParamInt_noLaskin,
    CertifParamInt_mvInitialFanDucy,
    CertifParamInt_mvInitialFanRpm,
    CertifParamInt_mvBlockFanDucy,
    CertifParamInt_mvBlockFanRpm,
    CertifParamInt_mvFinalFanDucy,
    CertifParamInt_mvFinalFanRpm,
    CertifParamInt_adcActual,

    CertifParamInt_Total
};
Q_ENUMS(CertifParamInteger)

enum HardwareInfo{
    HardwareInfo_Unknown,
    HardwareInfo_RPI_ZW,
    HardwareInfo_BPI_M2_Z
};
Q_ENUMS(HardwareInfo)
