...
public:
    ...
    QJsonObject getSwUpdateHistory(bool autoCheckEn = false);
    ...
    void getRpExtDatabase();
    void getRpExtDefault();

signals:
    void swUpdateAvailable(const QString &swuVersion, const QString &path, QJsonObject history);
    void swUpdateAvailableReset();
    void rpExtDatabaseObtained(QJsonObject value);
    void rpExtDefaultObtained(QJsonObject value);
...
private:
    ...
    QString m_rpExtDatabaseUrl;
    QString m_rpExtDefaultUrl;
