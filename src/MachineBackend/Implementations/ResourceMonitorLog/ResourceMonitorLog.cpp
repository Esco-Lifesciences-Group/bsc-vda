...
void ResourceMonitorLog::reInitialize()
{
...
void ResourceMonitorLog::emitSetResourceMonitorLogCount(int count)
{
    emit setResourceMonitorLogCount(count);
}

void ResourceMonitorLog::emitSetResourceMonitorLogIsFull(bool value)
{
    emit setResourceMonitorLogIsFull(value);
}
