...
#define DEFAULT_DB_LOCATION                 "systemmonitorlog.db"

#define DB_QUERY_INIT                       "\
CREATE TABLE IF NOT EXISTS systemmonitorlog_V3 \
(date TEXT,\
 time TEXT,\
 cpuUsage TXT,\
 memUsage TXT,\
...
#define DB_QUERY_ADD                        "INSERT INTO systemmonitorlog_V3 VALUES (?, ?, ?, ?, ?, ?, ?, ?)"

#define DB_QUERY_DELETE                     "DELETE FROM systemmonitorlog_V3"
#define DB_QUERY_DELETE_OLDEST_ROWID        "DELETE FROM systemmonitorlog_V3 WHERE ROWID = (SELECT ROWID FROM systemmonitorlog_V3 ORDER BY ROWID LIMIT 1)"
#define DB_QUERY_COUNT_ROWS                 "SELECT COUNT(*) FROM systemmonitorlog_V3"

//#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_ASC        "SELECT * FROM systemmonitorlog_V3 ORDER BY ROWID ASC LIMIT :limit OFFSET :offset;"
//#define DB_QUERY_SELECT_WITH_OFFSET_LIMIT_DESC       "SELECT * FROM systemmonitorlog_V3 ORDER BY ROWID DESC LIMIT :limit OFFSET :offset;"

//#define DB_QUERY_SELECT                     "SELECT * FROM systemmonitorlog_V3"
