...
/*
// If the USB Mass Storage is detected by fdisk -l but still not mounted,
// then probably you need to create the partition table type.
// It can be done by gparted.
// Partition table:
...
// go to "Device" > "Create partition table" and select msdos and set the type of file system to FAT32
*/
