...
#define DB_QUERY_ADD "\
INSERT INTO replaceablecomprecord_V2 VALUES \
(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,\
 ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,\
 ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,\
 ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,\
...
#define DB_QUERY_DELETE_OLDEST_ROWID    "DELETE FROM replaceablecomprecord_V2 WHERE ROWID = (SELECT ROWID FROM replaceablecomprecord_V2 ORDER BY ROWID LIMIT 1)"
...
bool ReplaceableCompRecordSql::querySelect(QVariantList *data, const QString &dbQueryConfig)
{
    qDebug () << __FUNCTION__ << thread();
...
bool ReplaceableCompRecordSql::queryDeleteAtRowId(int descRowId)
{
    qDebug () << __FUNCTION__ << thread();
